...
def process_data(
    ...
    for file_name in files:
        print("Processing file " + str(loadingBar + 1) + " of " + str(number_of_files))
        ...
        loadingBar += 1
        processedPercentage = loadingBar / number_of_files * 100
        send_event(session_id,'update_progress', {'percentage': processedPercentage})
